          ...
          @endif
            ...
            <form action="{{route('doctor.upload')}}" method="POST" enctype="multipart/form-data">
                ...
                <div style="padding:15px;">
                    ...
                    <input type="text" style="color:black;" name="name" placeholder="Write the name" requred="">
                </div>
                <div style="padding:15px;">
                    <label for="name">Phone Number</label>
                    <input type="text" style="color:black;" name="phone" placeholder="phone number" requred="">
                </div>
                <div style="padding:15px;">
                    <label for="room">Room Number</label>
                    <input type="text" style="color:black;" name="room" placeholder="Room number" requred="">
                </div>
                <div style="padding:15px;">
